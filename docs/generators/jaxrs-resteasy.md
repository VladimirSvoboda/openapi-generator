...
|distributionManagementId|Repository ID for distribution management in generated pom N.B. distributionManagementId, distributionManagementName and distributionManagementUrl must all be specified for any of them to take effect| |null|
|distributionManagementName|Repository name for distribution management in generated pom N.B. distributionManagementId, distributionManagementName and distributionManagementUrl must all be specified for any of them to take effect| |null|
|distributionManagementSnapshotId|Repository ID for snapshot distribution management in generated pom N.B. All distributionManagement* options must all be specified for any of the distributionManagementSnapshot* to take effect| |null|
|distributionManagementSnapshotName|Repository name for snapshot distribution management in generated pom N.B. All distributionManagement* options must all be specified for any of the distributionManagementSnapshot* to take effect| |null|
|distributionManagementSnapshotUrl|Repository URL for snapshot distribution management in generated pom N.B. All distributionManagement* options must all be specified for any of the distributionManagementSnapshot* to take effect| |null|
|distributionManagementUrl|Repository URL for distribution management in generated pom N.B. distributionManagementId, distributionManagementName and distributionManagementUrl must all be specified for any of them to take effect| |null|
